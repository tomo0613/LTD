...
import {BaseObject} from '../gameObject/BaseObject.js';
...
export function createAvatar(avatarImg: HTMLImageElement) {
    ...
    function fireProjectile() { // type: string, direction: Vector2
        ...
        function projectileIntersectionHandler(intersectingObjects: BaseObject[]) {
