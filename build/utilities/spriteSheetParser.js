const frameMapper = (function () {
    ...
    function init(_spriteSheet, _frameWidth, _frameHeight, options) {
    ...
    function extractFrame(xIndex, yIndex) {
        return createFrameBuffer(spriteSheet, yIndex * frameWidth, xIndex * frameHeight, frameWidth, frameHeight, 0, 0, Math.ceil(frameWidth * scale), Math.ceil(frameHeight * scale));
    }
...
export function parseSpriteSheet(spriteSheet, frameWidth, frameHeight, spriteSheetMapper, options) {
